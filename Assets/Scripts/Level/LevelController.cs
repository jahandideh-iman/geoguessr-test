...
namespace GeoGuessr.Game
{
    public interface ILevelViewPort
    {
        ...
        UniTask<int> ShowQuiz(Quiz quiz);
    }
    ...
    public record Quiz(QuizType Type, string Question, string? CustomImageID, Answer[] Answers, int CorrectAnswerIndex)
    {
    ...
    public record Answer(string? ImageID, string? Text)
    {
    ...
    public class LevelController
    {
        ...
        private async Task PlayQuizGame(QuizType quizType)
        {
            ...
            var answer = await ViewPort.ShowQuiz(quiz);
